...
import com.socialbox.movie.ui.MovieListAdapter.MovieHolder

class MovieDisplayAdapter: ListAdapter<Movie, MovieDisplayAdapter.MovieHolder>(MovieDiffCallback()) {
